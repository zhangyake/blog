<!DOCTYPE html>
<!-- saved from url=(0019)http://bubuzou.com/ -->
<html>
<head>
    ...
    <meta name="description" content="博客，主要是记录在技术、生活情感和摄影上的沉淀和感悟。">
    <meta name="keywords" content="web前端, HTML5, CSS3, JavaScript, SVG,  随笔, 生活情感, 摄影">
    <meta name="author" content="typeR">
    <link rel="short icon" href="http://bubuzou.com/images/favicon.ico">
    <link rel="stylesheet" href="{{ asset('css/bubuzou.css') }}">

    <style type="text/css">[data-hk-top-pages] {
            color: #333
        }

        .hit-kounter-top-title {
            padding: 5px;
            margin: .3em 0 .4em;
            font-size: 16px
        }

        .hit-kounter-top-table {
            width: 100%;
            border-collapse: collapse;
            font-size: 16px
        }

        .hit-kounter-top-table td {
            padding: 10px 5px
        }

        .hit-kounter-top-table td:last-child {
            text-align: right
        }

        .hit-kounter-top-table tr {
            border-top: 1px solid #aaa
        }

        .hit-kounter-top-table a {
            color: #5890ad;
...
<header>
    <div class="header row"><a href="#" class="logo-link"><img src="{{asset('images/logo.png')}}"></a>
        <ul class="nav nav-list">
            ...
            <li class="nav-list-item"><a href="/live/" target="_self" data-hover="生活"
                                         class="nav-list-link">生活</a></li>
            <li class="nav-list-item"><a href="/about/" target="_self" data-hover="关于"
                                         class="nav-list-link">关于</a></li>
        </ul>
        <div class="search"><a id="search_btn" href="http://bubuzou.com/#search"></a></div>
    </div>
</header>
...
<div class="modal search-modal">
    <div class="input-field"><input type="text" id="search_input"><label for="search-input">搜索</label></div>
...
<script src="{{asset('js/arAnchor.js')}}"></script>
