...
export default {
  ...
  methods: {
    ...
    handleUpdatePassword () {
      ...
      this.$api.updatePassword(this.passwordParam.oldPassword, this.passwordParam.newPassword).then(response => {
    ...
    handleUpdateProfile () {
      ...
      this.$api.updateProfile(this.user).then(response => {
